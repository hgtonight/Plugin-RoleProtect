...
<div class="Content"><?php
  ...
  $Roles = $this->Data['RoleData'];
  echo Wrap(T('Locked Roles'), 'h3');
  echo Wrap(T('These roles will not be modified by any user that has the selective roles permission.'), 'div', array('class' => 'Info'));
  echo $this->Form->CheckboxList('Plugins.RoleProtect.LockedRoles', array_flip($Roles));
